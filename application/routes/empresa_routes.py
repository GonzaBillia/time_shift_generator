...
def get_all_empresas():
    ...
    """
    try:
        empresas = controlador_py_logger_get_all_empresas()
...
def get_empresa_by_cuit(cuit: str):
    """
    Endpoint para obtener una empresa por su CUIT.
    """
    try:
        empresa = controlador_py_logger_get_by_cuit(cuit)
...
def get_empresa_by_razon_social(razon_social: str):
    ...
    """
    try:
        empresa = controlador_py_logger_get_by_razon_social(razon_social)
        empresa_schema = EmpresaResponse.model_validate(empresa)
        return success_response("Empresa encontrada", data=empresa_schema.model_dump())
    except HTTPException as he:
        raise he
...
def create_empresa(empresa_data: EmpresaBase):
    """
    ...
    try:
        ...
        empresa_creada = controlador_py_logger_create_empresa(nueva_empresa)
...
def update_empresa_partial(empresa_id: int, empresa_update: EmpresaUpdate):
    """
    ...
    try:
        ...
        empresa_actual = controlador_py_logger_get_by_id_empresa(empresa_id)
        ...
        empresa_actualizada = controlador_py_logger_update_empresa(empresa_to_update)
...
def delete_empresa(empresa_id: int):
    ...
    """
    try:
        resultado = controlador_py_logger_delete_empresa(empresa_id)
