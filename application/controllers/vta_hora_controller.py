...
from application.services.venta_hora_service import obtener_ventas_por_hora, obtener_facturas, obtener_personas_por_hora
...
def controlador_get_personas_por_hora(sucursal: int, fecha_desde: date, fecha_hasta: date, tiempo_promedio: int = 5) -> dict:
    try:
        return obtener_personas_por_hora(sucursal, fecha_desde, fecha_hasta, tiempo_promedio)
    except Exception as e:
